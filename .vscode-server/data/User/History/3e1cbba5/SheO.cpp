...
Rational Rational::add(const Rational &x) const{
   ...
   result.numerator = ( x.numerator * denominator ) + ( x.denominator * numerator ) ;
...
Rational Rational::subtract(const Rational &x) const{
   ...
   result.numerator = ( x.numerator * result.denominator ) - ( x.denominator * result.numerator ) ;
   result.denominator =  ( x.denominator * result.denominator ) ;
...
Rational Rational::multiply(const Rational &x) const{
   ...
   result.numerator = ( x.numerator * result.numerator ) ;
   result.denominator =  ( x.denominator * result.denominator ) ;
...
Rational Rational::divide(const Rational &x) const{
   ...
   result.numerator = ( x.numerator * result.denominator ) ;
   result.denominator =  ( x.denominator * result.numerator ) ;
